...
| Р3 | Корректность генератора заданий проверяется прогоном, а не доказательством: генератор порождает пары «условие — ответ», и согласованность пары можно проверять массово | набор из 3985 проверок, включая сверку вычисленного ответа с независимо посчитанным |
...
описания заданий и проверяется набором из 3985 автоматических проверок;
