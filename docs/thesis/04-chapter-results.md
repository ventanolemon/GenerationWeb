...
## 4.1. Проверка основной гипотезы: допуск из окрестности
...
## 4.2. Проверка согласованности пары «условие — ответ»
...
## 4.3. Проверка требования об одинаковом исполнении в двух средах
...
## 4.4. Оценка полноты покрытия предметных областей
...
затрагивают результатов §4.1–4.3.

---

## 4.6. Выводы по главе

1. Гипотеза главы 1 подтверждена: правило допуска, выводимое из
