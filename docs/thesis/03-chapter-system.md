...
| Охват | Число предметных областей с проверяемым ответом | **5** | перечень реализованных критериев эквивалентности | — | при изменении | **замер** |
...
2. Выделено шесть возможностей системы, каждая связана с задачей
   надсистемы; две из них (воспроизводимость варианта и проверяемость
   генератора) обычно не выделяются, но именно они закрывают проблемы,
   иначе неустранимые.
