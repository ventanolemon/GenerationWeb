...
| **G.02** (вторая модальность) Принимать верный ответ голосом | MOE₇: доля обучающихся, слышавших произношение изучаемого термина, % | MOE₇ = *N*с озвучкой / *N*всего × 100% | C.07 | MOP₇₁: **верных вердиктов среди вынесенных = 100%**<br>MOP₇₂: **доля вынесенных вердиктов = 71,7%**<br>MOP₇₃: покрытие поставки звуком = 462 из 463 |
