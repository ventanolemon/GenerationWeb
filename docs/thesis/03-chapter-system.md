...
| **G.02** (вторая модальность) Принимать верный ответ голосом | MOE₇: доля обучающихся, слышавших произношение изучаемого термина, % | MOE₇ = *N*с озвучкой / *N*всего × 100% | C.07 | MOP₇₁: верных вердиктов среди вынесенных = **100% на всех 14 словарях поставки** (§7.3.2; прежнее правило давало 91,3%)<br>MOP₇₂: **доля вынесенных вердиктов = 39,6%** — цена MOP₇₁<br>MOP₇₃: покрытие поставки звуком = **465 из 495** |
