...
Глава показывает, как решения главы 2 выражены в работающем комплексе.
Порядок изложения — от того, что описывает преподаватель, к тому, что
видит студент.

---

## 3.1. Язык описания задания
...
*Рис. 3.1. Описание задания «умножение двух чисел». Слева два источника
...
поставки той среды, которая исполняет граф (см. §2.5).

---

## 3.2. Порождение варианта
...
## 3.3. Спецификация ответа: ответ как данные
...
## 3.4. Правила эквивалентности по областям
...
## 3.5. Сопровождающие материалы задания
...
## 3.6. Автономная работа и согласование сред
