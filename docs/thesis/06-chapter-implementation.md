...
вердикта**. Мера уверенности — относительный отрыв ближайшего эталона от
следующего; при отрыве ниже порога вердикт не выносится, и у отказа
отдельный код. Различие принципиально: «я не расслышал» и «вы сказали не
то» — разные утверждения, и говорить студенту второе вместо первого
значит соврать о его ответе. Замер §7.3: из 120 попыток вердикт вынесен
в 86, и все 86 верны.
